...
export const WAIT_TURN_RULE =
  'After anything the student should see on the board (coach text, a played line, a demo), call how_to_ask_the_user with no arguments, then follow the returned instructions: render clickable buttons in this chat with your visualization UI. Do not use a numbered list. Do not put the question on the webpage. For a puzzle or exam, call how_to_offer_a_hint instead: the coach question must not spoil how to solve; the student taps Give me a hint in this chat if they want a nudge.';
